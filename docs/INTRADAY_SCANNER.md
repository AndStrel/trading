...
Сканер **не создаёт брокерских заявок и не открывает paper-позиции**. Он только создаёт материал для проверки. В Telegram кандидат отображается PNG-карточкой; она не является указанием купить или продать.
